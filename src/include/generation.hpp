...
template<typename>
struct create_item_with_first_dot;
...
template<typename _item>
using the_symbol_after_dot_is_nonterminal = ::std::is_base_of<nonterminal, typename the_symbol_after_dot<_item>::type>;


template<typename,typename>
struct move_dot_ahead_result;
...
template<typename _generation_T>
struct move_dot_ahead;
